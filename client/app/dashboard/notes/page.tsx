        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-[calc(100vh-200px)]">
                ...
                <div className="lg:col-span-1 space-y-4 overflow-y-auto pr-2">
                    ...
                    {history.map((session) => (
                        ...
                        >
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="font-bold text-slate-800 text-sm truncate max-w-[150px]">{session.title}</p>
                    ...
                    <button className="w-full py-3 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400 hover:text-indigo-500 hover:border-indigo-200 transition-all flex items-center justify-center text-sm font-medium">
