        ...
        <div className="space-y-6">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-md:max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
...
function GoalCard({ title, subtitle, progress, color, daysLeft }: any) {
    return (
        <div className="glass-card p-6 rounded-2xl flex flex-col justify-between h-64 bg-white dark:bg-slate-900 relative overflow-hidden group hover:shadow-lg transition-all border border-slate-100 dark:border-slate-800">
            <div className={`absolute top-0 left-0 w-1 h-full`} style={{ backgroundColor: color }}></div>

            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-xl font-bold text-slate-800 dark:text-white group-hover:text-indigo-600 transition-colors">{title}</h3>
