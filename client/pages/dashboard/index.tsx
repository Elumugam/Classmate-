                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="max-w-2xl">
                        ...
                        >
                            ...
                            <p className="text-sm font-bold text-indigo-700 dark:text-indigo-300 font-outfit">
                                {aiInsight}
                            </p>
                        </motion.div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right hidden sm:block">
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest font-outfit">Growth Points</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="p-8">
                        {todaysTasks.length === 0 ? (
                            <div className="text-center py-20 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-dashed border-slate-200 dark:border-slate-700">
                                ...
                                <p className="text-sm text-slate-400 mt-1 mb-6 font-outfit">Start your day by adding a few tasks.</p>
                            ...
                            <div className="space-y-4">
                                {todaysTasks.map((task) => (
                                    <div key={task._id} className="flex items-center gap-6 group">
                                        <div className="w-20 text-xs font-black text-slate-400 uppercase tracking-widest text-right font-outfit">
                                        ...
                                        <div className="relative flex-1 py-1">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500 font-medium mt-1 uppercase tracking-wider font-outfit">{task.subject}</p>
                                                </div>
                                                {task.completed ? (
                ...
                <aside className="lg:col-span-4 space-y-8">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[32px] p-8 border border-slate-200 dark:border-slate-800 shadow-sm text-center">
                        ...
                        <p className="text-sm text-slate-500 mt-2 mb-6 leading-relaxed font-outfit">Need help with your homework or a summary of your notes?</p>
    ...
    return (
        <div className="bg-white dark:bg-slate-900 p-6 rounded-[28px] border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition">
            ...
            <div className="mt-4">
                ...
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 font-outfit">{label}</p>
                <p className="text-xs text-slate-400 mt-2 font-medium font-outfit">{sub}</p>
            </div>
        </div>
    );
}
...
function SummaryItem({ label, value }: { label: string, value: string }) {
    return (
        <div className="flex justify-between items-end">
            <span className="text-sm font-bold text-indigo-100 opacity-80 font-outfit">{label}</span>
